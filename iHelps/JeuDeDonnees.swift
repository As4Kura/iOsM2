...
class JeuDeDonnee
{
    ...
    func creationJeuDonnees()
    {
        ...
        facade.creerUtilisateur("login0", mdp: "mdp0", adresse: "3 rue Issoudin Orleans", maDescription: "J'adore les poneys")
        facade.creerUtilisateur("login1", mdp: "mdp1", adresse: "2 rue Madeleine Orleans", maDescription: "J'adore les furets")
